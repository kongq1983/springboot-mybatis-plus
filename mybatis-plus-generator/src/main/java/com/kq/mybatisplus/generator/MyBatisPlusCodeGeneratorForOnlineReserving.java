 ...
 * @since 2020-0630
 */
public class MyBatisPlusCodeGeneratorForOnlineReserving {
    /**
     * 包名
     */
    public static final String PACKAGE_NAME = "com.hzsun.rs";
...
//        config.setPassword("26f696b8");
    ...
    private static void addJavaFile(List<FileOutConfig> focList, final PackageConfig pc,
        ...
        javaBuilder.append(gc.getOutputDir()).append("/com/hzsun/rs/");
