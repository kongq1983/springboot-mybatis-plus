 ...
 * @since 2020-0630
 */
public class MyBatisPlusCodeGeneratorForLocal {
    /**
     * 包名
     */
//    public static final String PACKAGE_NAME = "com.kq.mybatis.plus.common";
...
//        String[] tables = new String[]{"t_order_0","t_order_1","t_order_item_0","t_order_item_1","t_config"};
//        String[] tables = new String[]{"t_order","t_order_item","t_config"};
        String[] tables = new String[]{"t_article"};
...
//        String server = "172.16.6.202:3306/mybatis_plus";
        // localhost:3306/user_ds
//        String server = "localhost:3306/user_ds";
        String server = "localhost:3306/article_ds";
