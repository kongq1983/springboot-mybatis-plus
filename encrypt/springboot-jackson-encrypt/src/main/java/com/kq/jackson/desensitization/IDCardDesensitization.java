package com.kq.jackson.desensitization;
...
//    private static final Pattern PATTERN18 = Pattern.compile("^[1-9]\\d{5}(18|19|([23]\\d))\\d{2}((0[1-9])|(10|11|12))(([0-2][1-9])|10|20|30|31)\\d{3}[0-9Xx]$");
    private static final Pattern PATTERN18 = Pattern.compile("^[0-9]{18}$");
...
//        System.out.println(str.matches(PATTERN18));
        System.out.println(PATTERN18.matcher(str).find());
